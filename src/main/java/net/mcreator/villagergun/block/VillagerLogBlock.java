...
public class VillagerLogBlock extends VillagergunModElements.ModElement {
	@ObjectHolder("villagergun:villager_log")
	public static final Block block = null;
	public VillagerLogBlock(VillagergunModElements instance) {
		super(instance, 34);
	}
