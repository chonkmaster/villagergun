...
public class VillagerCampStructure extends VillagergunModElements.ModElement {
	public VillagerCampStructure(VillagergunModElements instance) {
		super(instance, 29);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("villagergun", "villager_camp"));
						if (template == null)
							return false;
