...
public class VillagerStoneBlock extends VillagergunModElements.ModElement {
	@ObjectHolder("villagergun:villagerstone")
	public static final Block block = null;
	public VillagerStoneBlock(VillagergunModElements instance) {
		super(instance, 11);
	}
