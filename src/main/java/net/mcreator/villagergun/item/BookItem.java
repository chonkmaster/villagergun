...
import net.mcreator.villagergun.procedures.BookUsedProcedure;
...
public class BookItem extends VillagergunModElements.ModElement {
	@ObjectHolder("villagergun:book")
	public static final Item block = null;
	@ObjectHolder("villagergun:entitybulletbook")
	public static final EntityType arrow = null;
	public BookItem(VillagergunModElements instance) {
		super(instance, 37);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbook").setRegistryName("entitybulletbook"));
	}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage", (double) 0, AttributeModifier.Operation.ADDITION));
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				int z = (int) entity.posZ;
				{
					...
					BookUsedProcedure.executeProcedure($_dependencies);
				}
			}
		}
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Items.BOOK, (int) (1));
		}
