...
package net.mcreator.villagergun.world.structure;
...
public class AbandonedTowerStructure extends VillagergunModElements.ModElement {
	public AbandonedTowerStructure(VillagergunModElements instance) {
		super(instance, 28);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("villagergun", "abandoned_tower"));
						if (template == null)
							return false;
