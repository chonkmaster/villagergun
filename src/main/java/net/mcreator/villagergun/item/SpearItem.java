...
public class SpearItem extends VillagergunModElements.ModElement {
	@ObjectHolder("villagergun:spear")
	public static final Item block = null;
	@ObjectHolder("villagergun:entitybulletspear")
	public static final EntityType arrow = null;
	public SpearItem(VillagergunModElements instance) {
		super(instance, 19);
	}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage", (double) 3, AttributeModifier.Operation.ADDITION));
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("villagergun:textures/maybecorrectspeartextures.png");
		...
		public void doRender(ArrowCustomEntity bullet, double d, double d1, double d2, float f, float f1) {
			...
			EntityModel model = new Modelspear4();
	...
	public static class Modelspear4 extends EntityModel {
		private final RendererModel spearthingy;
		public Modelspear4() {
			textureWidth = 32;
			textureHeight = 32;
			spearthingy = new RendererModel(this);
