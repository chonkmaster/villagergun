...
public class VillagerBlockBlock extends VillagergunModElements.ModElement {
	@ObjectHolder("villagergun:villagerblock")
	public static final Block block = null;
	public VillagerBlockBlock(VillagergunModElements instance) {
		super(instance, 10);
	}
